#!/usr/bin/env python3
"""
Google Ads CoreOS - Biblioteca compartilhada
...
_YAML_SEARCH_PATHS = [
    os.path.expanduser("~/.claude/skills/google-ads-coreos/google-ads.yaml"),
...
def init_client():
    ...
    print("  Crie o arquivo ~/.claude/skills/google-ads-coreos/.env com:", file=sys.stderr)
    ...
    print("  Ou rode: /google-ads-coreos setup", file=sys.stderr)
    sys.exit(1)
