...
Referencia completa para o Claude orientar o usuário durante o setup.
O usuário pode mandar prints de cada tela e o Claude deve comparar com os passos abaixo.

---

## Visao geral

Para a skill funcionar, o usuário precisa de:
...
→ O usuário precisa verificar a identidade na conta pessoal do Facebook primeiro.
...
3. Preencher:
   - **Nome:** qualquer nome (ex: "Meta Ads CoreOS", "Minha Skill Ads")
   - **Email de contato:** email do usuário
   - **Conta comercial:** selecionar a que aparece (ou "Nenhuma conta" se nao tiver)
4. Clicar em **"Criar app"**

**O que o usuário vai ver:** um painel com o app criado, mostrando o App ID no topo.
...
**IMPORTANTE:** Mesmo o token estendido expira em 60 dias. O usuário vai precisar regerar eventualmente. Se os comandos comecarem a dar erro de autenticacao, provavelmente o token expirou.
